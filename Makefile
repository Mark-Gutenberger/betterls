...
windows:
	$(CXX) -c ./colorls.cpp -o $(OUT_DIR)$(OBJ_DIR)colorls-$(PLATFORM)-$(VERSION).o $(LINKFLAGS) $(CXXFLAGS) $(LFLAGS)
	$(CXX) $(OUT_DIR)$(OBJ_DIR)colorls-$(PLATFORM)-$(VERSION).o -o $(OUT_DIR)colorls-$(PLATFORM)-$(VERSION).exe $(LINKFLAGS) $(CXXFLAGS) $(LFLAGS)
	$(CXX) -S ./colorls.cpp -o $(OUT_DIR)$(ASM_DIR)colorls-$(PLATFORM)-$(VERSION).asm $(LINKFLAGS) $(CXXFLAGS) $(LFLAGS)
